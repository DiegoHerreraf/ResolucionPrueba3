...
<html>
    ...
    <body>
        ...
        <table border="0" width="500" align="center">
            <form name="formanadir" method="post" action="${pageContext.request.contextPath}/ServletController">
                <tr>
                    ...
                    <th>Cantidad</th>
                    <th><input type="number" id="txtCantidad" value="" min="1" name="txtCantidad" value="0" required=""/></th>
                </tr><tr>
